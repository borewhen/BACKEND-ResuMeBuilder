...
Revision ID: 79127f7cb87f
Revises: e8aee9faef7f
Create Date: 2025-02-06 10:51:19.046913
...
revision: str = '79127f7cb87f'
down_revision: Union[str, None] = 'e8aee9faef7f'
...
def upgrade() -> None:
    ...
    op.execute("""
INSERT INTO public.users (role, username, password, email, first_name, last_name, profile_picture_url, summary, created_at)
VALUES 

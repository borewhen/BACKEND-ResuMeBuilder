...
from app.routers import user,video, job,resume_extraction, mock_interview , course, video_interview # Import routers
...
app.include_router(video_interview.router,prefix="/video_interview",tags=["Video_Interview"])

...
from app.routers import user, job,resume_extraction, transcript_extraction  # Import routers
...
app.include_router(transcript_extraction.router, prefix="/transcript", tags = ["transcript_extraction"])
